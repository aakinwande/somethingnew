    ...
    <div className="ghost-container">
      <div className="market">
        <div class="main-ghost">
          <h6 className="main-header-market">
            We’ll mold your audience’s feelings about your brand into whatever
            you want{" "}
          </h6>
      ...
      <div className="ghost-writring-what-we-do">
        <h4 className="ghost-header">MARKETING AND PUBLIC RELATIONS</h4>
        <p className="ghost-service">
          Some our comprehensive marketing services by genre are:
        </p>
        <section className="featured-background">
          <div className="box">
            <h4>
              <a className="gtext" href="/brand-content">
          ...
          <div className="box">
            <h4>
              <a className="gtext" href="/personal-public-image">
