  ...
  return (
    <div className="fiction-container">
      <div className="fiction">
        <div class="main-fiction">
          <h5 className="main-header-fiction">
            Ghostwriting Fiction Is Both Art and Science{" "}
          </h5>
          <p className="para-ghost">
            Work with Kick's writers and editors to write your novel and reach
            your readers.{" "}
          </p>
          <a
