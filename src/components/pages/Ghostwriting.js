      ...
      <div className="ghost-container">
        <div className="ghost">
          <div class="main-ghost">
            ...
            <p className="para-ghost">
              Let’s talk about your book idea! If you haven’t got ideas that’s
              okay, we’ll listen to your story and brainstorm for you
            </p>
            <a
        ...
        <div className="ghost-writring-what-we-do">
          ...
          <p className="ghost-service">
            Some our comprehensive ghostwriting services by genre are:
          </p>
          ...
          <div className="content grid">
            <div className="box btn_shadow">
              <a href="/marketing">
                ...
                <p className="what-we-do-params">
                  ...
                  life. Experienced ghostwriters is to assist you in
                  articulating your thoughts, concepts, and tales into polished
                  and entertaining material while keeping completely
                  confidential.
                </p>
              </a>
            </div>
            <div className="box btn_shadow">
              <a href="/copywriting">
                ...
                <p className="what-we-do-params">
                  Enhance your message, captivate the attention of your
                  audience, and motivate real action. We offer expert
                  copywriting services that are aimed to provide your
                  organization with convincing and compelling material that has
                  a long-term impact.
                </p>
              </a>
            </div>
            <div className="box btn_shadow">
              <a href="/marketing">
                ...
                <p className="what-we-do-params">
                  ...
                  committed to helping your business prosper and connect with
                  your target audience on a meaningful level by having a strong
                  awareness of the ever-changing marketing landscape and a
                  passion for developing great storytelling.
                </p>
              </a>
            </div>
          </div>
