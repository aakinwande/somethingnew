  ...
  return (
    <div className="socialmedia-container">
      <div className="socialmedia">
        <div class="main-socialmedia">
          <h5 className="main-header-socialmedia">
            Build your social media with expertly written articles{" "}
          </h5>
          <p className="para-ghost">
            Compelling content supported by scholarly research.
          </p>
          <a
