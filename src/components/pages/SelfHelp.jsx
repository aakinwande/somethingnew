  ...
  return (
    <div className="selfhelp-container">
      <div className="selfhelp">
        <div class="main-selfhelp">
          <h5 className="main-header-selfhelp">
            Self-Help Book Ghostwriting and Publishing Navigation{" "}
          </h5>
          <p style={{ color: "white" }} className="para-ghost">
            Your message has the power to change lives. Let us help you write
            your book and reach your readers.
          </p>
          <a
