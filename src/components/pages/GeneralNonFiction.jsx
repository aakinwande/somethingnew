  ...
  return (
    <div className="nonfiction-container">
      <div className="nonfiction">
        <div class="main-nonfiction">
          <h5 className="main-header-nonfiction">
            Nonfiction Ghostwriting and Publishing Navigation
          </h5>
          <p className="para-ghost">
            Become a published author with the help of bestselling ghostwriters
            and Big-5 editors
          </p>
          <a
